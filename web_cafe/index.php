	...
	<div class="container"> 
        ...
        <div class="content"> 
        	<div class="left"> 
                ...
                <ul> 
                	<li><a href="hangcaphe.php">HÃNG CAFE </a></li>
            ...
            <div class="mid">
                ...
                <table style="margin:25px;">
                	<tr> 
                    	<td><img src="images/logo_17.gif" width="224" height="190"></td>
                        <td style="padding-left:10px;" valign="top" >Cà phê Arabica, Được trồng tại Lâm Đồng, Việt Nam, Mùi thơm nồng, vị hơi chua  <br>
                        	<p style="margin-top: 32px">Gía: <span style="text-decoration:line-through; color:red;"> 47.900.000 VND </span> </p>
                            <p style="margin-top: 10px">Còn: <span style= "color:red;"> 32.500.000 VND </span> </p>
                            <div style="margin-top:45px;">
                            	<img src="images/mua ngay.gif" width="178" height="30"><img src="images/chitiet.jpg" width="144" height="30">
                            </div>
                        </td>
                    </tr>
                    <tr> 
